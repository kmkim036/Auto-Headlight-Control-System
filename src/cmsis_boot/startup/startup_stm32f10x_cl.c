/**
 ******************************************************************************
 * @file      startup_stm32f10x_md.c(103) // startup_stm32f10x_cl.c  (107VCT)
 * @author    Coocox
 * @version   V1.0
 * @date      12/23/2009
...
#include "yInc.h"
/*----------Stack Configuration-----------------------------------------------*/  
#define STACK_SIZE       0x00000400      /*!< was 200 The Stack size suggest using even number     */
...
void WEAK  OTG_FS_WKUP_IRQHandler(void);//107VCT //
void WEAK  USBWakeUp_IRQHandler(void);//--103
...
extern void USART2_IRQHandler(void);//for LIN
...
#ifdef STM32F103C8//(PROCESSOR == STM32F103C8)
...
{       
  ...
  USART2_IRQHandler,            /*!< 38: USART2 for LIN                       */
...
#pragma weak USBWakeUp_IRQHandler = Default_Handler   //103
#pragma weak OTG_FS_WKUP_IRQHandler = Default_Handler //107

#if (PROCESSOR == STM32F107VCT)
