...
static u8 g_Ap3216_regArrayCache[Ap3216_NUM_CACHABLE_REGS] = { 0x00, 0x01, 0x02, 0x0a, 0x0b,
    0x0c, 0x0d, 0x0e, 0x0f,
...
static int __Ap3216_Read_Reg_fromLocalCache(u32 reg, u8 mask, u8 shift)
{
    ...
    GetIndexFromRegAddr(reg, idx) return (g_Ap3216_Module.reg_cache[idx] & mask) >> shift;
}
...
void __Ap3216_Write_Reg_ByI2cAndLocalCache(u32 reg, u8 mask, u8 shift, u8 val)
{
    ...
    GetIndexFromRegAddr(reg, idx) if (idx >= Ap3216_NUM_CACHABLE_REGS) return; // -1;
