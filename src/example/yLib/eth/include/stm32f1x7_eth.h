...
#ifndef __STM32F1x7_ETH_H
#define __STM32F1x7_ETH_H
...
#include "core_cm3.h"
 ...
 #ifdef USE_Delay
 #include "lwipmain.h"                /* Header file where the Delay function prototype is exported */
...
/** 
  ...
  *   By calling the ETH_StructInit function the structure뭩 fields are set to their default values.
...
#define ETH_PTPTSSR     ((uint32_t)0x00000728)  /* PTP Time Stamp Status Register at 0x0728*/
...
/** 
  * @brief  PHY  
  */ 
uint16_t ETH_ReadPHYRegister(uint16_t PHYAddress, uint16_t PHYReg, unsigned int *result);
