...
#ifndef __STM32F1x7_ETH_BSP_H
#define __STM32F1x7_ETH_BSP_H
...
#undef USE_ENHANCED_DMA_DESCRIPTORS
 ...
 /* Redefinition of the Ethernet driver buffers size and count */
  ...
  #define ETH_RXBUFNB        2 //20                  /* 20 Rx buffers of size ETH_RX_BUF_SIZE */
  #define ETH_TXBUFNB        2 //5                   /* 5  Tx buffers of size ETH_TX_BUF_SIZE */
 #endif
#endif
