...
#define USE_ENHANCED_DMA_DESCRIPTORS //PTP Support
#if (PROCESSOR == PROCESSOR_STM32F107VCT)
#undef USE_ENHANCED_DMA_DESCRIPTORS // Not used in STM32F107
#endif

typedef struct  {
  uint32_t   Status;                /*!des0 = Status */
  uint32_t   ControlBufferSize;     /*!des1 = Control and Buffer1, Buffer2 lengths */
  uint32_t   Buffer1Addr;           /*!des2 = Buffer1 address pointer or TimeStampLow*/
  uint32_t   Buffer2NextDescAddr;   /*!des3 = Buffer2 or next descriptor address pointer or TimeStampHigh*/
  /* Enhanced ETHERNET DMA PTP Descriptors: Valid only for STM32F407 */
...
/* 5 Ethernet driver receive buffers are used (in a chained linked list)*/
 #define ETH_RXBUFNB            2 //5     /*  5 Rx buffers of size ETH_RX_BUF_SIZE */
...
//=======================
 ...
 #endif
#endif//(PROCESSOR == PROCESSOR_STM32F107VCT)
